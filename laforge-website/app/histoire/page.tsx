...
const mockTimeline = [
  {
    ...
    excerpt: 'Création de l\'équipe avec une vision claire: former les meilleurs athlètes du Québec et leur offrir une plateforme pour exceller.',
    category: 'foundation',
  },
  {
    id: '2',
    year: 2021,
    title: 'Première saison PrepU',
    excerpt: 'Intégration réussie dans la ligue PrepU Canada. Notre équipe fait ses preuves avec une saison remarquable.',
    category: 'milestone',
  },
  {
    id: '3',
    ...
    excerpt: 'Victoire historique au championnat régional. Une performance qui établit La Forge comme force majeure du basketball québécois.',
    category: 'victory',
  },
  {
    id: '4',
    year: 2023,
    title: 'Expansion des installations',
    excerpt: 'Ouverture de nouvelles installations d\'entraînement au Pavillon Saint-Lambert, doublant notre capacité d\'accueil.',
    category: 'expansion',
  },
  {
    id: '5',
    year: 2024,
    title: 'Programme de développement jeunesse',
    excerpt: 'Lancement d\'un programme innovant pour développer les jeunes talents et préparer la prochaine génération.',
    category: 'milestone',
  },
  {
    id: '6',
    ...
    excerpt: 'Notre équipe continue de croître avec 19 athlètes d\'élite et des ambitions nationales.',
    category: 'milestone',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden md:flex w-2/12 justify-center">
                    <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${categoryColors[item.category as keyof typeof categoryColors]} flex items-center justify-center shadow-lg z-10`}>
        ...
        >
          <p className="text-[var(--blanc-platine)]/60 italic">
            Le contenu de l&apos;histoire sera géré via l&apos;interface admin Sanity
          </p>
        </motion.div>
      </div>
    </div>
